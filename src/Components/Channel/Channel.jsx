  ...
  return (
    <div className='channel'>
      ...
      <div className='channel-menu'>
        ...
        <button onClick={() => channelContentDisplay('playlists')}>Playlists</button>
        <button onClick={() => channelContentDisplay('community')}>Community</button>
      </div>
